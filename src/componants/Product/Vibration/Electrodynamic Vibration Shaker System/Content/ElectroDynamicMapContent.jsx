...
const ElectrodynamicMapContent = {
  ...
  Heading2:"Products-Series-Electrodynamic Component",
  Image: [
    {
      img: (
        <>
          <Link style={{textDecoration: 'none'}} to="/Vibration/Air-Cooled-Series">
            <img
              ...
              className="Mappedimg"
            />
            <Link style={{textDecoration: 'none'}} to="/Vibration/Air-Cooled-Series"className="text-content-ac">
              <h6 className="text-ac" >
                Air Cooled Vibration <br/>Testing System
              </h6>
            </Link>
          </Link>
        </>
        ...
        <>
          <Link style={{textDecoration: 'none'}} to="/Vibration/Water-Cooled-Series">
            <img
              ...
              className="Mappedimg"
            />
            <Link style={{textDecoration: 'none'}} to="/Vibration/Water-Cooled-Series" className="text-content-ac">
              <h6 className="text-ac" >Water-Cooled-Series </h6>
            </Link>
          </Link>
        </>
      ),
...
export default ElectrodynamicMapContent;
