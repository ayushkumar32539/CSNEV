    ...
    const MyTableData = props.data.Section_5.Table_data.map((data, index) => {
        return (
          <tr>
            ...
            <td className="Bump-Section5-td">{data.DBTM1010H.split('\n').map(str => <p>{str}</p>)}</td>
            <td className="Bump-Section5-td">{data.DCFG40K15.split('\n').map(str => <p>{str}</p>)}</td>
            <td className="Bump-Section5-td">{data.DCFG80K10.split('\n').map(str => <p>{str}</p>)}</td>
          </tr>
        );
      });
  return (
            ...
            <Table striped bordered >
              <thead>
                <tr className="Bump-Section5-tr">
                  ...
                  <th className="Bump-Section5-th">
                    {props.data.Section_5.Table_Heading6}
                  </th>
                  <th className="Bump-Section5-th">
                    {props.data.Section_5.Table_Heading7}
                  </th>
                  <th className="Bump-Section5-th">
                    {props.data.Section_5.Table_Heading8}
                  </th>
                </tr>
              </thead>
              <tbody>
